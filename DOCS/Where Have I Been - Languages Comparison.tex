...
\bibitem{gregcalendar} GregorianCalendar (Java Platform SE 7), {\em docs.oracle}, [online], http://docs.oracle.com/javase/7/docs/api/java/ util/GregorianCalendar.html (Accessed:27/03/2014)
...
\bibitem{javaxml} How to create XML file in Java - (DOM parser), {\em mkyong}, [online], http://www.mkyong.com/java/how-to-create-xml-file-in-java-dom/ (Accessed:27/03/2014)
